...
cormat <- round(cor(cfa_data.clean[,2:27],use="complete.obs"),2) #removed !is.na function and added 'use="complete.obs"' instead - correlations worryingly high with !is.na version
...
#shortened labels for correlation plot
coord_plot_labels <- c("GAD7: Anxious", "GAD7: Difficulty controlling worrying","GAD7: Worrying too much", "GAD7: Trouble relaxing", "GAD7: Restlessness","GAD7: Irritable","GAD7: Feeling afraid", "PHQ9: Anhedonia", "PHQ9: Depressed mood", "PHQ9: Sleep change", "PHQ9: Little energy", "PHQ9: Weight or appetite problems", "PHQ9: Worthlessness", "PHQ9: Concentration problems", "PHQ9: Motor problems", "PHQ9: Suicide ideation", "MASQ-AD: Successful", "MASQ-AD: Happy", "MASQ-AD: Optimistic", "MASQ-AD: Fun", "MASQ-AD: Accomplished", "MASQ-AD: Looking forward", "MASQ-AD: Talkative", "MASQ-AD: Lively", "MASQ-AD: Full of energy", "MASQ-AD: Good")
...
ggheatmap <- ggplot(melted_cormat, aes(Var2, Var1, fill = value))+
 ...
 theme(axis.text.x = element_text(angle = 90, vjust = 1, 
    size = 8, hjust = 1))+
  scale_x_discrete(label=coord_plot_labels) +
  scale_y_discrete(label=coord_plot_labels) +
 coord_fixed()
...
ggsave(filename=file.path(dirname(dirname(getwd())),"output/supplementary_tables_figures/CFA_correlations.png"),
       plot=ggheatmap)
```
