...
![best fit model for trajectories of symptoms of depression over one year of the pandemic](../../output/Trajectory_plots/PHQ/phq_fiveclass_trajectory.png "Five class GMM for depression symptoms")
...
![best fit model for trajectories of symptoms of anxiety over one year of the pandemic](../../output/Trajectory_plots/GAD/gad_fiveclass_trajectory.png "Five class GMM for anxiety symptoms")
...
#phq_class <-read.table("../GrowthMixtureModelling/MPlus_input_gmm/PHQ/gmm_phq_piece_5class_probs.dat", 
#                           header=FALSE)

#gad_classes <- read.table("../GrowthMixtureModelling/MPlus_input_gmm/GAD/gmm_gad_piece_5class_probs.dat", 
#                           header=FALSE)
...
#phq.AllData <- phq.AllData[!apply(is.na(phq.AllData[,4:18]), 1, all),]

#gad.AllData <- gad.AllData[!apply(is.na(gad.AllData[,4:18]), 1, all),]

masq.AllData <- masq.AllData[!apply(is.na(masq.AllData[,4:18]), 1, all),]
...
```{r cross tabs mental heath controls phq}

tbl_cross(phq.AllData, 
          row=MostLikelyClass, col=mental_health_controls,
          percent = "row")
...
```{r cross tabs mental heath controls gad}
...
```{r cross tabs mental heath controls masq}
...
phq.AllData$mental_health_controls <- factor(phq.AllData$mental_health_controls,
                                       levels=c("Any mental health disorder","No mental health diagnosis")) %>%
  relevel(phq.AllData$mental_health_disorders, ref = "No mental health diagnosis")
...
gad.AllData$mental_health_controls <- factor(gad.AllData$mental_health_controls,
                                       levels=c("Any mental health disorder","No mental health diagnosis")) %>%
  relevel(gad.AllData$mental_health_disorders, ref = "No mental health diagnosis")
...
masq.AllData$mental_health_controls <- factor(masq.AllData$mental_health_controls,
                                       levels=c("Any mental health disorder","No mental health diagnosis")) %>%
  relevel(masq.AllData$mental_health_disorders, ref = "No mental health diagnosis")
...
formula_clustered <- "MostLikelyClass ~ age + gender + ethnicity_clustered + employment_prior_covid + employment_change +key_worker + anxiety_disorders + depressive_disorders + eating_disorders +obsessive_compulsive_disorders +psychotic_disorders + personality_disorders + bipolar_disorders + mental_health_controls"

formula <- "MostLikelyClass ~ age + gender + ethnicity + employment_prior_covid + employment_change +key_worker + anxiety_disorders + depressive_disorders + eating_disorders +obsessive_compulsive_disorders +psychotic_disorders + personality_disorders + bipolar_disorders + mental_health_controls"
```
