...
gad.totals.clean <- gad.totals.clean %>%
    group_by(ID) %>% 
    filter(!duplicated(ID,
                      fromLast = TRUE)
           ) %>%
...
write.dat(gad.mplus, "../../../data_clean/gad/gad.clean_merged_total_scores.dat")
write_csv(gad.mplus.names, "../../../data_clean/gad/gad.clean_merged_total_scores.dat/gad.clean_merged_total_scores_codebook.csv")
