...
COPING_baseline.id <- left_join(COPING_baseline, COPING_EDGI.id)
...
COPING_followupA.id <- COPING_followupA %>% #new dataset with ID
  ...
  select(-phq.difficult_daily_life_issues,
         ...
         startDate,
         endDate,
         phq9.pandemic_nervous_anxious_on_edge = phq.feeling_nervous_anxious_or_on_edge,
         phq9.pandemic_cant_control_worry = phq.control_worrying_stop,
         phq9.pandemic_worry_too_much = phq.worrying_too_much_about_different_things,
         phq9.pandemic_trouble_relaxing = phq.trouble_relaxing,
         phq9.pandemic_restless = phq.sit_hard_restless,
         phq9.pandemic_easily_annoyed = phq.becoming_easily_annoyed_or_irritable,
         phq9.pandemic_afraid_something_terrible_will_happen = phq.awful_happen_feeling_afraid)
...
COPING_followupB.id <- COPING_followupB %>% #new dataset with ID
  ...
  select(-phq.difficult_daily_life_issues,
         ...
         endDate,
         phq9.pandemic_nervous_anxious_on_edge = phq.feeling_nervous_anxious_or_on_edge,
         phq9.pandemic_cant_control_worry = phq.stop_control_worrying,
         phq9.pandemic_worry_too_much = phq.worrying_too_much_about_different_things,
         phq9.pandemic_trouble_relaxing = phq.trouble_relaxing,
         phq9.pandemic_restless = phq.hard_sit_restless,
         phq9.pandemic_easily_annoyed = phq.becoming_easily_annoyed_or_irritable,
         phq9.pandemic_afraid_something_terrible_will_happen = phq.awful_feeling_afraid_happen)
...
COPING_followupA.id.long <- COPING_followupA.id %>%
  ...
  tidyr::pivot_wider(id_cols = ID, 
    names_from = waveA, 
                     values_from = c(phq9.pandemic_nervous_anxious_on_edge,
                                     phq9.pandemic_cant_control_worry,
                                     phq9.pandemic_worry_too_much,
                                     phq9.pandemic_trouble_relaxing,
                                     phq9.pandemic_restless,
                                     phq9.pandemic_easily_annoyed,
                                     phq9.pandemic_afraid_something_terrible_will_happen)) 
...
COPING_baseline.id %>% 
  freq(phq9.pandemic_nervous_anxious_on_edge_.Wave_0_unc)
```
...
COPING_followupA.id.long %>% 
  freq(phq9.pandemic_cant_control_worry_.Wave_03_unc)
```
...
COPING_followupA_ong.id.long %>% 
  freq(phq9.pandemic_nervous_anxious_on_edge_.Wave_05_unc)
```
...
phq.COPING.reordered <- phq.COPING %>% 
  select(order(names(phq.COPING)),
         -startDate,
         -endDate) %>%
  relocate(ID, .before = phq9.pandemic_afraid_something_terrible_will_happen_.Wave_0)
...
RAMP_baseline.id <- RAMP_baseline %>% #new dataset with ID
  ...
  select(
         ID = "Login ID", # ID
         phq9.pandemic_nervous_anxious_on_edge = phq9.feeling_nervous_anxious_or_on_edge,
         phq9.pandemic_cant_control_worry = phq9.control_worrying_stop,
         phq9.pandemic_worry_too_much = phq9.worrying_too_much_about_different_things,
         phq9.pandemic_trouble_relaxing = phq9.trouble_relaxing,
         phq9.pandemic_restless = phq9.sit_hard_restless,
         phq9.pandemic_easily_annoyed = phq9.becoming_easily_annoyed_or_irritable,
         phq9.pandemic_afraid_something_terrible_will_happen = phq9.awful_feeling_afraid_happen)
...
RAMP_baseline.id %>% 
  freq(phq9.pandemic_cant_control_worry_.Wave_0_unc)
```
...
RAMP_followupA.id.long %>% 
  freq(phq9.pandemic_nervous_anxious_on_edge_.Wave_01_unc)
```
...
RAMP_followupB.id.long %>% 
  freq(phq9.pandemic_nervous_anxious_on_edge_.Wave_02_unc)
```
...
```{r}
#Scoring variables
PHQ.n.items = 7 # Enter here the total number of items of the questionnaire
...
PHQ.total.score_upper_limit = 21
...
keys_phq <- c(1,1,1,1,1,1,1)
items_phq <- generate_items(0)
