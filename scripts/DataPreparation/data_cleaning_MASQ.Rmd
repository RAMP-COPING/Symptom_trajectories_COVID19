...
saveRDS(object = masq.COPING, file = paste0("../../../data_clean/COPING_masq/masq.clean_merged_A_B_long", date, ".rds"))
```
...
RAMP_followupA.id <- RAMP_followupA.id %>%
  mutate(waveA = case_when(startDate >= ramp_start1 & startDate < ramp_start2 ~ ".Wave_1A",
                           startDate >= ramp_start2 & startDate <= ramp_end2 ~ ".Wave_1A_in_2B",
                            startDate >= ramp_start3 & startDate <= ramp_end3 ~ ".Wave_3A",
                           startDate >= ramp_start4 & startDate <= ramp_end4 ~ ".Wave_3A_in_4B",
                            startDate >= ramp_start5 & startDate <= ramp_end5 ~ ".Wave_5A",
                           startDate >= ramp_start6 & startDate <= ramp_end6 ~ ".Wave_5A_in_6B",
                            startDate >= ramp_start7 & startDate <= ramp_end7 ~ ".Wave_7A",
                           startDate >= ramp_start8 & startDate <= ramp_end8 ~ ".Wave_7A_in_8B",
                            startDate >= ramp_start9 & startDate <= ramp_end9 ~ ".Wave_9A",
                           startDate >= ramp_start10 & startDate <= ramp_end10 ~ ".Wave_9A_in_10B",
                            startDate >= ramp_start11 & startDate <= ramp_end11 ~ ".Wave_11A",
                           startDate >= ramp_start12 & startDate <= ramp_end12 ~ ".Wave_11A_in_12B",
                            startDate >= ramp_start13 & startDate <= ramp_end13 ~ ".Wave_13A",
                              startDate >= ramp_start14 & startDate <= ramp_end14 ~ ".Wave_13A_in_14B",
                            startDate >= ramp_start15 & startDate <= ramp_end15 ~ ".Wave_15A",
                            startDate >= ramp_start16 & startDate <= ramp_end16 ~ ".Wave_15A_in_16B",
                           startDate >= ramp_start17 & startDate <= ramp_end17 ~ ".Wave_17A",
                           startDate >= ramp_start18 & startDate <= ramp_end18 ~ ".Wave_17A_in_18B",
                            startDate >= ramp_start19 & startDate <= ramp_end19 ~ ".Wave_19A")
         )
...
RAMP_followupB.id <- RAMP_followupB.id %>%
  mutate(waveB = case_when(startDate >= ramp_start1 & startDate < ramp_end1 ~ ".Wave_1A_in_B", # should be impossible to exist
                           startDate >= ramp_start2 & startDate < ramp_start3 ~ ".Wave_2B",
                            startDate >= ramp_start3 & startDate <= ramp_end3 ~ ".Wave_2B_in_3A",
                           startDate >= ramp_start4 & startDate <= ramp_end4 ~ ".Wave_4B",
                            startDate >= ramp_start5 & startDate <= ramp_end5 ~ ".Wave_4B_in_5A",
                           startDate >= ramp_start6 & startDate <= ramp_end6 ~ ".Wave_6B",
                            startDate >= ramp_start7 & startDate <= ramp_end7 ~ ".Wave_6B_in_7A",
                           startDate >= ramp_start8 & startDate <= ramp_end8 ~ ".Wave_8B",
                            startDate >= ramp_start9 & startDate <= ramp_end9 ~ ".Wave_8B_in_9A",
                           startDate >= ramp_start10 & startDate <= ramp_end10 ~ ".Wave_10B",
                            startDate >= ramp_start11 & startDate <= ramp_end11 ~ ".Wave_10B_in_11A",
                           startDate >= ramp_start12 & startDate <= ramp_end12 ~ ".Wave_12B",
                            startDate >= ramp_start13 & startDate <= ramp_end13 ~ ".Wave_12B_in_13A",
                              startDate >= ramp_start14 & startDate <= ramp_end14 ~ ".Wave_14B",
                            startDate >= ramp_start15 & startDate <= ramp_end15 ~ ".Wave_14B_in_15A",
                            startDate >= ramp_start16 & startDate <= ramp_end16 ~ ".Wave_16B",
                           startDate >= ramp_start17 & startDate <= ramp_end17 ~ ".Wave_16B_in_17A",
                           startDate >= ramp_start18 & startDate <= ramp_end18 ~ ".Wave_18B",
                            startDate >= ramp_start19 & startDate <= ramp_end19 ~ ".Wave_18B_in_19A"))
...
saveRDS(object = masq.RAMP, file = paste0("../../../data_clean/RAMP_masq/masq.clean_merged_followup_long.RAMP", date, ".rds"))
saveRDS(object = RAMP_baseline.id.clean, file = paste0("../../../data_clean/RAMP_masq/masq.clean_merged_baseline.RAMP", date, ".rds"))
```
