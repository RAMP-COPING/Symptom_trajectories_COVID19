...
saveRDS(object = masq.RAMP, file = paste0("../../../data_clean/RAMP_masq/masq.clean_merged_followup_long.RAMP", ".rds"))
saveRDS(object = RAMP_baseline.id.clean, file = paste0("../../../data_clean/RAMP_masq/masq.clean_merged_baseline.RAMP",  ".rds"))
```
