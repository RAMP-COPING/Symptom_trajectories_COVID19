...
2. We dropped timepoints 1, 2 and 17 (first two follow ups before COPING had started data collection and last follow up where we currednlty don't have RAMP data extracted) NOTE: timepoint 17 to be included when extraction issue resolved

## Overview of of models

* Linear
* Quadratic
* Piecewise version 1: four pieces, corresponding with lockdowns and easing of restrictions between April 2020 and April 2021 (see below)
* TO TAKE THIS OUT: Piecewise version 2: three pieces, corresponding with lockdowns and easing of restrictions, but with no inflection for the March 2021 onward restriction easing as these were gradual and not as temporally well-defined 
...
#### Trajectory 1 - DELETE HEADING
Four pieces **These dates are based on guidelines in England - TO CHECK no major discrepancies across Scotland; NI; Wales**:
...
Slope includes data points: Follow-up 12 (17 Nov 2020) - Follow-up 14 (12 Jan 2021)
**WE WILL CHANGE THIS TO NOV-FEB FOR FINAL MODEL ONCE EXTRACTION ISSUE RESOLVED**

4. Spring 2021 easing of restrictions (8 Mar 2021) until end of study period (6 Apr 2021)
Slope includes data points: Follow-up 15 (9 Feb 2021) - Follow-up 16 (9 Mar 2021)
**WE WILL CHANGE THIS TO MAR-APR FOR FINAL MODEL ONCE EXTRACTION ISSUE RESOLVED**
...
Looking at our data structure and MPlus output, I suspect this is due to missing data from COPING survey for waves 2 & 3, and from the RAMP survey at wave 17 at present (due to data extraction issue)    

The 10% (0.1) minimum covariance coverage default in MPlus may not be appropriate for large datasets when there may be a sufficiently large sample of individuals wit hon-missing data, even if that represents less than 10% of the sample. 

Will try the following to resolve this by: 
* running without timepoints 2, 3 and 17   
* adapting the minimum coverage requirement 

**update** After removing timepoins 2, 3 and 17, the lowest remaining covariance coverage value is 0.007 between time point 3 and timepoint 13. The lowest sample size between these is 19298 at timepoint 13. 
