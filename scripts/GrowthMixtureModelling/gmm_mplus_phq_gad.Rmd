...
anx.traj.all$gad_latentGrowthCurve_linear.out$output[321:337]  %>%   str_split("/t") %>%   kbl() %>%   kable_styling(bootstrap_options = "striped")
```
...
anx.traj.all$gad_latentGrowthCurve_linear_withpairwiseCorrelations.out$output[284:316]  %>%   str_split("/t") %>%   kbl() %>%   kable_styling(bootstrap_options = "striped")
...
anx.traj.all$gad_latentGrowthCurve_linear_withpairwiseCorrelations.out$output[367:383]  %>%   str_split("/t") %>%   kbl() %>%   kable_styling(bootstrap_options = "striped")
```
...
anx.traj.all$gad_latentGrowthCurve_linear_withpairwiseCorrelations.out$output[685:729]  %>%   str_split("/t") %>%   kbl() %>%   kable_styling(bootstrap_options = "striped")
```
...
anx.traj.all$gad_latentGrowthCurve_quadratic.out$output[289:339]  %>%   str_split("/t") %>%   kbl() %>%   kable_styling(bootstrap_options = "striped")
...
anx.traj.all$gad_latentGrowthCurve_quadratic_withPairwiseCorrelations.out$output[289:339]  %>%   str_split("/t") %>%   kbl() %>%   kable_styling(bootstrap_options = "striped")
...
anx.traj.all$gad_latentGrowthCurve_piecewise.out$output[332:416]  %>%   str_split("/t") %>%   kbl() %>%   kable_styling(bootstrap_options = "striped")
...
anx.traj.all$gad_latentGrowthCurve_piecewise.out$output[442:458]  %>%   str_split("/t") %>%   kbl() %>%   kable_styling(bootstrap_options = "striped")
```
...
anx.traj.all$gad_latentGrowthCurve_piecewise.out$output[794:840]  %>%   str_split("/t") %>%   kbl() %>%   kable_styling(bootstrap_options = "striped")
```
...
anx.traj.all$gad_latentGrowthCurve_piecewise_wPairwise_correlations.out$output[336:420]  %>%   str_split("/t") %>%   kbl() %>%   kable_styling(bootstrap_options = "striped")
...
anx.traj.all$gad_latentGrowthCurve_piecewise_wPairwise_correlations.out$output[690:706]  %>%   str_split("/t") %>%   kbl() %>%   kable_styling(bootstrap_options = "striped")
```
...
anx.traj.all$gad_latentGrowthCurve_piecewise_wPairwise_correlations.out$output[882:926]  %>%   str_split("/t") %>%   kbl() %>%   kable_styling(bootstrap_options = "striped")
```
...
growth_curves_run2 <- ggplot() +
  ...
  scale_y_continuous(expand = c(0,0), limits = c(4.5,6.5), breaks=seq(4.5, 6.5, 1)) + 
  scale_x_continuous(expand = c(0,0), limits = c(-0.5,14.5), breaks=seq(0, 14, by = 1)) +
  theme(panel.grid.major.y = element_line(size = 0.5,
                                        linetype = 'dashed',
                                        colour = "gray"),
