...
throws error but does print (in console, not in markdown. Need to format a version that will display in Markdown)
...
1. test original 4 peice model that corresponds better to lockdown. May need to fix ntercepts to make it run with fewer timepoints.
2. test seasonal piecewise maybe? (Discuss with Katie)
