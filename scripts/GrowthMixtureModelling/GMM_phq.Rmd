...
growth_curves_oneclass <- ggplot() +
  ...
  geom_hline(yintercept=5, linetype="dashed", color = "#FFDBA4") +
  geom_hline(yintercept=10, linetype="dashed", color = "#FF9E6E") +
  geom_hline(yintercept=15, linetype="dashed", color = "#FF603B") +
  geom_hline(yintercept=20, linetype="dashed", color = "#FF0000") +
...
growth_curves_fiveclass <- ggplot() +
 ...
 geom_hline(yintercept=0, linetype="dashed", color = "grey") +
  ...
  geom_hline(yintercept=20, linetype="dashed", color = "#FFB3B3") +
  theme(panel.grid.major.y = element_blank(),
        axis.text = element_text(colour="black", size = 14),
        axis.title = element_text(colour="black", size = 16),
        axis.text.x = element_text(angle = 90,
