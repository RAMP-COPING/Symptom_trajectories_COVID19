...
# Supplementary checks, tables and figures

## fit indices for all models run
read all GMM models. Note that I copy each output into an output folder for this step as the extra output that is generated while the scripts are running throws errors. When all models are run, it will be easier to delete the output art of this file reference, and get rid of those duplicates. 

It's likely that to do so, you will need to specify what output gets read in in this next step using the "what = c("summaries","class_counts") command to avoid reading in any .dat files generated.
```{r read all models} 
...
BIC_scree_plot <- ggplot() +
  ...
  scale_y_continuous(limits =c(1745000,1772500), breaks = seq(1745000,1772500,by=2500)) +
...
save_kable(summary_table,
           file.path(save_file_path,"phq_gmm_allModelsfitStatistics.html"))

# save BIC scree
ggsave(
  filename=file.path(save_file_path,"phq_BIC_scree_plot.png"),
  plot =BIC_scree_plot)
    
ggsave(
  filename=file.path(save_file_path,"phq_BIC_scree_plot-start-at-two.png"),
  plot =BIC_scree_plot2)

# save class proportion data tables
save_kable(class_allocation_2,
           file.path(save_file_path,"phq_gmm_class_allocation_numbers_2class.html"))

save_kable(class_allocation_3,
           file.path(save_file_path,"phq_gmm_class_allocation_numbers_3class.html"))

save_kable(class_allocation_4,
           file.path(save_file_path,"phq_gmm_class_allocation_numbers_4class.html"))

save_kable(class_allocation_5,
           file.path(save_file_path,"phq_gmm_class_allocation_numbers_5class.html"))

save_kable(class_allocation_6,
           file.path(save_file_path,"phq_gmm_class_allocation_numbers_6class.html"))

save_kable(class_allocation_7,
           file.path(save_file_path,"phq_gmm_class_allocation_numbers_7class.html"))
...
growth_curves_oneclass <- ggplot() +
  ...
  labs(x = "Follow up time point", y ="PHQ-9 Score") +
...
dat_plot_curves_two$Class2<- depression.two.class.out$gh5$means_and_variances_data$y_estimated_means$values[,2]
dat_plot_curves_two$Observed1<- depression.two.class.out$gh5$means_and_variances_data$y_observed_means$values[,1]
dat_plot_curves_two$Observed2<- depression.two.class.out$gh5$means_and_variances_data$y_observed_means$values[,2]
...
dat_plot_curves_three$Class2<- depression.three.class.out$gh5$means_and_variances_data$y_estimated_means$values[,2]
dat_plot_curves_three$Class3<- depression.three.class.out$gh5$means_and_variances_data$y_estimated_means$values[,3]

dat_plot_curves_three$Observed1<- depression.three.class.out$gh5$means_and_variances_data$y_observed_means$values[,1]
dat_plot_curves_three$Observed2<- depression.three.class.out$gh5$means_and_variances_data$y_observed_means$values[,2]
dat_plot_curves_three$Observed3<- depression.three.class.out$gh5$means_and_variances_data$y_observed_means$values[,3]
...
dat_plot_curves_four$Class2<- depression.four.class.out$gh5$means_and_variances_data$y_estimated_means$values[,2]
dat_plot_curves_four$Class3<- depression.four.class.out$gh5$means_and_variances_data$y_estimated_means$values[,3]
dat_plot_curves_four$Class4<- depression.four.class.out$gh5$means_and_variances_data$y_estimated_means$values[,4]

dat_plot_curves_four$Observed1<- depression.four.class.out$gh5$means_and_variances_data$y_observed_means$values[,1]
dat_plot_curves_four$Observed2<- depression.four.class.out$gh5$means_and_variances_data$y_observed_means$values[,2]
dat_plot_curves_four$Observed3<- depression.four.class.out$gh5$means_and_variances_data$y_observed_means$values[,3]
dat_plot_curves_four$Observed4<- depression.four.class.out$gh5$means_and_variances_data$y_observed_means$values[,4]
...
dat_plot_curves_five$Class2<- depression.five.class.out$gh5$means_and_variances_data$y_estimated_means$values[,2]
dat_plot_curves_five$Class3<- depression.five.class.out$gh5$means_and_variances_data$y_estimated_means$values[,3]
dat_plot_curves_five$Class4<- depression.five.class.out$gh5$means_and_variances_data$y_estimated_means$values[,4]
dat_plot_curves_five$Class5<- depression.five.class.out$gh5$means_and_variances_data$y_estimated_means$values[,5]

dat_plot_curves_five$Observed1<- depression.five.class.out$gh5$means_and_variances_data$y_observed_means$values[,1]
dat_plot_curves_five$Observed2<- depression.five.class.out$gh5$means_and_variances_data$y_observed_means$values[,2]
dat_plot_curves_five$Observed3<- depression.five.class.out$gh5$means_and_variances_data$y_observed_means$values[,3]
dat_plot_curves_five$Observed4<- depression.five.class.out$gh5$means_and_variances_data$y_observed_means$values[,4]
dat_plot_curves_five$Observed5<- depression.five.class.out$gh5$means_and_variances_data$y_observed_means$values[,5]
...
dat_plot_curves_six$Class2<- depression.six.class.out$gh5$means_and_variances_data$y_estimated_means$values[,2]
dat_plot_curves_six$Class3<- depression.six.class.out$gh5$means_and_variances_data$y_estimated_means$values[,3]
dat_plot_curves_six$Class4<- depression.six.class.out$gh5$means_and_variances_data$y_estimated_means$values[,4]
dat_plot_curves_six$Class5<- depression.six.class.out$gh5$means_and_variances_data$y_estimated_means$values[,5]
dat_plot_curves_six$Class6<- depression.six.class.out$gh5$means_and_variances_data$y_estimated_means$values[,6]


dat_plot_curves_six$Observed1<- depression.six.class.out$gh5$means_and_variances_data$y_observed_means$values[,1]
dat_plot_curves_six$Observed2<- depression.six.class.out$gh5$means_and_variances_data$y_observed_means$values[,2]
dat_plot_curves_six$Observed3<- depression.six.class.out$gh5$means_and_variances_data$y_observed_means$values[,3]
dat_plot_curves_six$Observed4<- depression.six.class.out$gh5$means_and_variances_data$y_observed_means$values[,4]
dat_plot_curves_six$Observed5<- depression.six.class.out$gh5$means_and_variances_data$y_observed_means$values[,5]
dat_plot_curves_six$Observed6<- depression.six.class.out$gh5$means_and_variances_data$y_observed_means$values[,6]
...
dat_plot_curves_seven$Class2<- depression.seven.class.out$gh5$means_and_variances_data$y_estimated_means$values[,2]
dat_plot_curves_seven$Class3<- depression.seven.class.out$gh5$means_and_variances_data$y_estimated_means$values[,3]
dat_plot_curves_seven$Class4<- depression.seven.class.out$gh5$means_and_variances_data$y_estimated_means$values[,4]
dat_plot_curves_seven$Class5<- depression.seven.class.out$gh5$means_and_variances_data$y_estimated_means$values[,5]
dat_plot_curves_seven$Class6<- depression.seven.class.out$gh5$means_and_variances_data$y_estimated_means$values[,6]
dat_plot_curves_seven$Class7<- depression.seven.class.out$gh5$means_and_variances_data$y_estimated_means$values[,7]


dat_plot_curves_seven$Observed1<- depression.seven.class.out$gh5$means_and_variances_data$y_observed_means$values[,1]
dat_plot_curves_seven$Observed2<- depression.seven.class.out$gh5$means_and_variances_data$y_observed_means$values[,2]
dat_plot_curves_seven$Observed3<- depression.seven.class.out$gh5$means_and_variances_data$y_observed_means$values[,3]
dat_plot_curves_seven$Observed4<- depression.seven.class.out$gh5$means_and_variances_data$y_observed_means$values[,4]
dat_plot_curves_seven$Observed5<- depression.seven.class.out$gh5$means_and_variances_data$y_observed_means$values[,5]
dat_plot_curves_seven$Observed6<- depression.seven.class.out$gh5$means_and_variances_data$y_observed_means$values[,6]
dat_plot_curves_seven$Observed7<- depression.seven.class.out$gh5$means_and_variances_data$y_observed_means$values[,7]
...
# set up folder reference
save_file_path <- file.path(dirname(dirname(getwd())),"output/Trajectory_plots/PHQ/")

# save all trajectory plots
ggsave(
  filename=file.path(save_file_path,"phq_oneclass_trajectory.png"),
  plot =growth_curves_oneclass, 
  width = 14, height = 10, dpi = 150, units = "in")

ggsave(
  filename=file.path(save_file_path,"phq_twoclass_trajectory.png"),
  plot =growth_curves_twoclass, 
  width = 14, height = 10, dpi = 150, units = "in")

ggsave(
  filename=file.path(save_file_path,"phq_threeclass_trajectory.png"),
  plot =growth_curves_threeclass, 
  width = 14, height = 10, dpi = 150, units = "in")

ggsave(
  filename=file.path(save_file_path,"phq_fourclass_trajectory.png"),
  plot =growth_curves_fourclass, 
  width = 14, height = 10, dpi = 150, units = "in")

ggsave(
  filename=file.path(save_file_path,"phq_fiveclass_trajectory.png"),
  plot =growth_curves_fiveclass, 
  width = 14, height = 10, dpi = 150, units = "in")

ggsave(
  filename=file.path(save_file_path,"phq_sixclass_trajectory.png"),
  plot =growth_curves_sixclass, 
  width = 14, height = 10, dpi = 150, units = "in")

ggsave(
  filename=file.path(save_file_path,"phq_sevenclass_trajectory.png"),
...
## run OPTSEED replication steo 1 and two. 

This will also get LRT output and class probability data

Top replicated log likelihood to run optseed is: 521575

```{r run optseed model}

runModels("./MPlus_input_gmm/PHQ/OPTSEED_replications/", 
          recursive = TRUE,
          showOutput=TRUE)
