...
pres.palette <- c("#4ED1B7", "#F6C66A", "#6564DB", "#D90368","#481620",  "#6F7C12","#061A40") 
...
depression.two.class.out <- readModels("./MPlus_input_gmm/PHQ/output/phq_GMM_piecewise_2_classes.out", 
                           recursive=FALSE)
...
depression.three.class.out <- readModels("./MPlus_input_gmm/PHQ/output/phq_GMM_piecewise_3_classes.out", 
                           recursive=FALSE)
...
depression.four.class.out <- readModels("./MPlus_input_gmm/PHQ/output/phq_GMM_piecewise_4_classes.out", 
                           recursive=FALSE)
...
depression.five.class.out <- readModels("./MPlus_input_gmm/PHQ/output/phq_GMM_piecewise_5_classes.out", 
                           recursive=FALSE)
...
depression.six.class.out <- readModels("./MPlus_input_gmm/PHQ/output/phq_GMM_piecewise_6_classes.out", 
                           recursive=FALSE)
...
depression.seven.class.out <- readModels("./MPlus_input_gmm/PHQ/output/phq_GMM_piecewise_7_classes.out", 
                           recursive=FALSE)
...
save_kable(class_allocation_3,
           file.path(save_file_path,"phq_gmm_class_allocation_numbers_3class"))

save_kable(class_allocation_4,
           file.path(save_file_path,"phq_gmm_class_allocation_numbers_4class"))

save_kable(class_allocation_5,
           file.path(save_file_path,"phq_gmm_class_allocation_numbers_5class"))

save_kable(class_allocation_6,
           file.path(save_file_path,"phq_gmm_class_allocation_numbers_6class"))

save_kable(class_allocation_7,
           file.path(save_file_path,"phq_gmm_class_allocation_numbers_7class"))
