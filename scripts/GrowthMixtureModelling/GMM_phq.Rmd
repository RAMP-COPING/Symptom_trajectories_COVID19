...
round(depression.all.out$phq_GMM_piecewise_2_classes.out$class_counts$mostLikely,2) %>%
...
round(depression.all.out$phq_GMM_piecewise_3_classes.out$class_counts$mostLikely,2) %>%
...
round(depression.all.out$phq_GMM_piecewise_4_classes.out$class_counts$mostLikely,2) %>%
...
round(depression.all.out$phq_GMM_piecewise_5_classes.out$class_counts$mostLikely,2) %>%
...
round(depression.all.out$phq_GMM_piecewise_6_classes.out$class_counts$mostLikely,2) %>%
...
round(depression.all.out$phq_GMM_piecewise_7_classes.out$class_counts$mostLikely,2) %>%
