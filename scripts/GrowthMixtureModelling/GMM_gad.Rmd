...
BIC_scree_plot2 <- ggplot() +
  geom_line(data =justSummaries[1:6,],
        aes(x = Title, y = BIC,group=1)) +
  scale_x_discrete(name="k+1 class model",labels=c("Two class growth mixture model","Three class growth mixture model","four class growth mixture model","Five class growth mixture model","Six class growth mixture model","Seven class growth mixture model")) +
...
ggsave(
  filename=file.path(save_file_path,"gad_BIC_scree_plot-start-at-two.png"),
