...
growth_curves_oneclass <- ggplot() +
 ...
 geom_hline(yintercept=0, linetype="dashed", color = "grey") +
  ...
  geom_hline(yintercept=5, linetype="dashed", color = "#FFB3B3") +
  geom_hline(yintercept=10, linetype="dashed", color = "#FFB3B3") +
  geom_hline(yintercept=15, linetype="dashed", color = "#FFB3B3") +
