...
BIC_scree_plot <- ggplot() +
  ...
  scale_x_discrete(name="k+1 class model",labels=c("Latent growth curve (One class)","Two class growth mixture model","Three class growth mixture model","four class growth mixture model","Five class growth mixture model")) +
...
```
# Optimal Class Model: Descriptives
