...
Partiuclarly need to make sure that the selected model has >1% of the sample in the smallest class.

2 class
```{r two class most likely counts}

round(anxiety.all.out$gad_GMM_piecewise_2_classes.out$class_counts$mostLikely,2) %>%
...
round(anxiety.all.out$gad_GMM_piecewise_3_classes.out$class_counts$mostLikely,2) %>%
...
round(anxiety.all.out$gad_GMM_piecewise_4_classes.out$class_counts$mostLikely,2) %>%
...
round(anxiety.all.out$gad_GMM_piecewise_5_classes.out$class_counts$mostLikely,2) %>%
...
round(anxiety.all.out$gad_GMM_piecewise_6_classes.out$class_counts$mostLikely,2) %>%
...
round(anxiety.all.out$gad_GMM_piecewise_7_classes.out$class_counts$mostLikely,2) %>%
