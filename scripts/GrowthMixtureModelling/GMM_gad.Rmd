...
pres.palette <- c("#4ED1B7", "#F6C66A", "#6564DB", "#481620",  "#3B413C","#061A40","#D90368") 
...
anxiety.two.class.out <- readModels("./MPlus_input_gmm/GAD/output/gad_GMM_piecewise_2_classes.out", 
                           recursive=FALSE)
...
anxiety.three.class.out <- readModels("./MPlus_input_gmm/GAD/output/gad_GMM_piecewise_3_classes.out", 
                           recursive=FALSE)
...
anxiety.four.class.out <- readModels("./MPlus_input_gmm/GAD/output/gad_GMM_piecewise_4_classes.out", 
                           recursive=FALSE)
...
anxiety.five.class.out <- readModels("./MPlus_input_gmm/GAD/output/gad_GMM_piecewise_5_classes.out", 
                           recursive=FALSE)
...
anxiety.six.class.out <- readModels("./MPlus_input_gmm/GAD/output/gad_GMM_piecewise_6_classes.out", 
                           recursive=FALSE)
...
anxiety.seven.class.out <- readModels("./MPlus_input_gmm/GAD/output/gad_GMM_piecewise_7_classes.out", 
                           recursive=FALSE)
...
save_kable(class_allocation_3,
           file.path(save_file_path,"gad_gmm_class_allocation_numbers_3class"))

save_kable(class_allocation_4,
           file.path(save_file_path,"gad_gmm_class_allocation_numbers_4class"))

save_kable(class_allocation_5,
           file.path(save_file_path,"gad_gmm_class_allocation_numbers_5class"))

save_kable(class_allocation_6,
           file.path(save_file_path,"gad_gmm_class_allocation_numbers_6class"))

save_kable(class_allocation_7,
           file.path(save_file_path,"gad_gmm_class_allocation_numbers_7class"))
